...
public class KafkaProtocolFactory extends ProtocolImplFactory {

  public KafkaProtocolFactory() {
    super("kafka", "Provides a connection to an Apache Kafka cluster", new NoOpDetection());
  }

  @Override
  public Protocol connect(EndPoint endPoint, String sessionId, String username, String password) throws IOException {
    ExtensionConfigDTO protocolConfigDTO = (ExtensionConfigDTO) ((ExtensionEndPoint) endPoint).config();
    Protocol protocol = new ExtensionProtocol(endPoint, new KafkaProtocol(endPoint, protocolConfigDTO));
  ...
  public void create(EndPoint endPoint, Packet packet) {
    // This extension does not accept inbound Kafka client sockets.
  }
